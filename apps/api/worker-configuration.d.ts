/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b297fda944262a9b620efb57ea7ad7d5)
// Runtime types generated with workerd@1.20260128.0 2026-03-25 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		R2_BUCKET: R2Bucket;
		CORS_ORIGINS: "https://kost.iydheko.site, http://localhost:3000, http://localhost:5173";
		DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ORIGINS" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
